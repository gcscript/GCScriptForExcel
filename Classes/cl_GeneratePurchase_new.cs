...
namespace GCScript_for_Excel.Classes
{
    public class cl_GeneratePurchase_new
    {
        ...
        void RemoveFillColumns()
        {
            ...
            Range Column1Compra_Range = ExcelFunctions.GetRangeColumnByName(gWs, ColumnsName.Parcela1);
            Range Column2Compra_Range = ExcelFunctions.GetRangeColumnByName(gWs, ColumnsName.Parcela2);
